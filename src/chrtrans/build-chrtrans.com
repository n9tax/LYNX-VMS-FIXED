...
$!
$!   MODIFIED 2026-08-28 for OpenVMS VAX 7.3 / DEC C:
$!     both CHRcc_opts branches now set /ACCEPT=NOVAXC_KEYWORDS and
$!     /DEFINE=(UCX).  The transport define is required because the
$!     LY_SOCKADDR typedef in www_tcp.h is unconditional and needs
$!     struct sockaddr_in complete.  Change UCX here if you build
$!     with a different transport (TCPIP, MULTINET, SOCKETSHR_TCP).
$!     See VAX_INSTALL_README.md at the top of this tree.
$!
...
$ if p1 .nes. ""
$   then
$      CHRcc_opts = "/ACCEPT=NOVAXC_KEYWORDS/DEBUG/NOOPT/DEFINE=(UCX)"
$      CHRlink_opts = "/DEBUG"
$   else
$      CHRcc_opts = "/ACCEPT=NOVAXC_KEYWORDS/DEFINE=(UCX)"
$      CHRlink_opts = ""
$ endif
$!
$ Compile_makeuctb:
